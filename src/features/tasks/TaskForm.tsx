    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
        ...
        <Box component="form" noValidate sx={{ mt: 1 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2 }}>
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <TextField {...field} select fullWidth label="Priority" sx={{ mb: 2 }}>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <TextField {...field} select fullWidth label="Status" sx={{ mb: 2 }}>
      ...
      <DialogActions sx={{ px: 3, pb: 2 }}>
        ...
        <Button
          ...
          disabled={isPending}
        >
          {isPending ? <CircularProgress size={20} /> : task ? 'Update' : 'Create'}
        </Button>
      </DialogActions>
    </Dialog>
  );
